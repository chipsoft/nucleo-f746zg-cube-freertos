...
//		"-----BEGIN CERTIFICATE-----\n"
//		"MIICuTCCAl+gAwIBAgIUON5HBFBa0qLiZq/aE0DEGpocDsUwCgYIKoZIzj0EAwIw\n"
//		"gbExCzAJBgNVBAYTAkRFMQ8wDQYDVQQIDAZIZXNzZW4xGjAYBgNVBAcMEUZyYW5r\n"
//		"ZnVydCBhbSBNYWluMRQwEgYDVQQKDAtCZXJ0aW4gR21iaDExMC8GA1UEAwwoRGVu\n"
//		"eXMgU3VwcnVuZW5rbyAoQmVydGluIEdtYmgpIChSb290IENBKTEsMCoGCSqGSIb3\n"
//		"DQEJARYdZGVueXMuc3VwcnVuZW5rb0BiZXJ0aW4uZ3JvdXAwHhcNMjMwNzIwMDg0\n"
//		"NzM3WhcNMzMwNzE3MDg0NzM3WjCBsTELMAkGA1UEBhMCREUxDzANBgNVBAgMBkhl\n"
//		"c3NlbjEaMBgGA1UEBwwRRnJhbmtmdXJ0IGFtIE1haW4xFDASBgNVBAoMC0JlcnRp\n"
//		"biBHbWJoMTEwLwYDVQQDDChEZW55cyBTdXBydW5lbmtvIChCZXJ0aW4gR21iaCkg\n"
//		"KFJvb3QgQ0EpMSwwKgYJKoZIhvcNAQkBFh1kZW55cy5zdXBydW5lbmtvQGJlcnRp\n"
//		"bi5ncm91cDBZMBMGByqGSM49AgEGCCqGSM49AwEHA0IABHIC7lZZ9iZUUQQD4L8T\n"
//		"8j53cl10MqklRxpKkGW7wlcqNs1qlC5rCQI3kHXJ/UvvSGlP8DxOKQe/8elFjvKu\n"
//		"my6jUzBRMB0GA1UdDgQWBBTjD812xI/9hlFgsrAbqOQRvVVsqDAfBgNVHSMEGDAW\n"
//		"gBTjD812xI/9hlFgsrAbqOQRvVVsqDAPBgNVHRMBAf8EBTADAQH/MAoGCCqGSM49\n"
//		"BAMCA0gAMEUCICl5q+8P9xImAp5c42BSgOP2NQU1cXsqqKnGsZqk72rIAiEA9GJT\n"
//		"vv5F3jHbTo4lcCpFar5DZW7EzypRxOgvrtW6rKE=\n"
//		"-----END CERTIFICATE-----\n";
...
//		"-----BEGIN PRIVATE KEY-----\n"
//		"MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgHqxbv8cpnMwL3oYY\n"
//		"Rc562odz2K0n7/+ugwpRDIvl/BehRANCAARyAu5WWfYmVFEEA+C/E/I+d3JddDKp\n"
//		"JUcaSpBlu8JXKjbNapQuawkCN5B1yf1L70hpT/A8TikHv/HpRY7yrpsu\n"
//		"-----END PRIVATE KEY-----\n";
...
static void handle_stats_get(struct mg_connection *c) {
  ...
  mg_http_reply(c, 200, s_json_header, "{%m:%d,%m:%d,%m:[%M]}",
                MG_ESC("temperature"), 21 + add,  //
                MG_ESC("humidity"), 67 + add,     //
